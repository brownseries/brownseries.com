            ...
            <div className="w-full max-w-7xl mx-auto md:px-8 mt-20 md:mt-24 md:grid md:grid-cols-2 md:gap-12">
                ...
                <div className="w-full relative">
                    ...
                    <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2 md:hidden">
                        {images.map((_, i) => (
                            <div key={i} className={`w-1.5 h-1.5 rounded-full ${i === 0 ? "bg-warm-white" : "bg-warm-white/30"}`} />
                        ))}
                    </div>
                </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="flex gap-3">
                            {colors.map((color) => (
                                ...
                                >
                                    <span className="w-8 h-8 rounded-full border border-black/10" style={{ backgroundColor: color.hex }} />
                                </button>
                            ))}
                        </div>
                    </div>
