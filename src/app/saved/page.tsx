      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex items-center gap-8 border-b border-white/5 mb-6 md:mb-10 overflow-x-auto hide-scrollbar">
          <button
            ...
            className={`pb-4 text-[13px] font-bold uppercase tracking-[0.15em] transition-all relative flex items-center gap-2 ${
              activeTab === "items"
                ? "text-warm-white"
        ...
        <div className="min-h-[400px]">
          ...
          {SAVED_ITEMS.length === 0 && activeTab === "items" && (
            <div className="flex flex-col items-center justify-center py-20 text-center gap-6">
              ...
              <div className="flex flex-col gap-2">
                <h2 className="text-2xl text-warm-white font-medium">
                  Your wishlist is empty
                </h2>
                <p className="text-[13px] text-foreground/60 max-w-xs mx-auto">
                  Tap the heart icon on any item in the shop to save it here.
                </p>
              </div>
              <Link
                href="/shop"
                className="px-8 py-4 bg-warm-white text-background rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-accent transition-colors"
              >
                Explore Shop
              </Link>
            </div>
