...
export default function Footer() {
    return (
        <footer className="bg-[#0a0807] border-t border-white/5 pt-16 pb-24 md:pb-16 text-warm-white">
            <div className="max-w-7xl mx-auto px-6 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
                    ...
                    {/* Info Links */}
                    <div className="md:col-span-2 md:col-start-7 flex flex-col items-center md:items-start text-center md:text-left gap-4">
                        <h3 className="font-[family-name:var(--font-outfit)] text-[12px] uppercase text-warm-white/90 tracking-widest mb-2 font-medium">Explore</h3>
                    ...
                    <div className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left gap-4">
                        <h3 className="font-[family-name:var(--font-outfit)] text-[12px] uppercase text-warm-white/90 tracking-widest mb-2 font-medium">Support</h3>
                    ...
                    {/* Socials & Legal */}
                    <div className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left gap-4">
                        <h3 className="font-[family-name:var(--font-outfit)] text-[12px] uppercase text-warm-white/90 tracking-widest mb-4 font-medium">Connect</h3>
                        ...
                        <div className="mt-auto pt-6 text-[11px] font-[family-name:var(--font-outfit)] text-foreground/40 text-center md:text-left">
