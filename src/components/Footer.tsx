      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col items-center md:flex-row md:justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-[10px] text-foreground/40">
            © 2026 Brown Series. Social commerce platform.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end gap-5">
          ...
          <div className="flex gap-5">
            <a
              href="https://www.instagram.com/brown.series/"
              target="_blank"
              className="text-foreground/50 hover:text-warm-white transition-colors"
            >
              {/* Instagram */}
              <svg
                className="w-4 h-4"
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 2.23-1.13 4.41-2.92 5.75-1.74 1.3-4.08 1.72-6.19 1.12-2.17-.61-4.01-2.22-4.81-4.32-.79-2.07-.61-4.48.56-6.38 1.15-1.9 3.2-3.1 5.4-3.32v4.06c-1.14.07-2.24.64-2.91 1.54-.66.88-.86 2.06-.5 3.09.34.99 1.19 1.78 2.19 2.09.99.3 2.11.19 2.99-.34.84-.52 1.38-1.42 1.48-2.39.11-1.1.04-2.2.04-3.3V.02h3.61z"
                  clipRule="evenodd"
                />
              </svg>
            </a>
