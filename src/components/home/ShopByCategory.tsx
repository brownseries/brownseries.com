    ...
    return (
        <section className="bg-background pt-12 md:pt-16 pb-4 md:pb-8">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                <div className="ml-0 flex md:grid md:grid-cols-4 gap-4 md:gap-6 overflow-x-auto hide-scrollbar overscroll-x-contain touch-pan-x snap-x snap-mandatory pb-4 -mx-4 px-4 md:mx-0 md:px-0 md:pb-0">                    {/* Category 1 */}
