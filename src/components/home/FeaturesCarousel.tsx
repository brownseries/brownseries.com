        ...
        <section className="bg-surface/30 md:border-y md:border-white/5 py-6 md:py-10">
            ...
            <div className="max-w-7xl mx-auto px-4 overflow-x-auto hide-scrollbar overscroll-x-contain touch-pan-x snap-x snap-mandatory flex md:grid md:grid-cols-4 gap-4 md:gap-8 pb-2 md:pb-0">
                ...
                <div className="flex flex-col md:flex-row items-center gap-3 justify-center text-center md:text-left min-w-[200px] md:min-w-0 snap-center bg-surface/50 md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none">
                    ...
                    <span className="text-[13px] md:text-[14px] font-medium md:font-light text-foreground/90">Free Delivery over $20</span>
                </div>
                {/* Feature 2 */}
                <div className="flex flex-col md:flex-row items-center gap-3 justify-center text-center md:text-left min-w-[200px] md:min-w-0 snap-center bg-surface/50 md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none">
                    ...
                    <span className="text-[13px] md:text-[14px] font-medium md:font-light text-foreground/90">4.9 / 5 TrustScore</span>
                </div>
                {/* Feature 3 */}
                <div className="flex flex-col md:flex-row items-center gap-3 justify-center text-center md:text-left min-w-[200px] md:min-w-0 snap-center bg-surface/50 md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none">
                    ...
                    <span className="text-[13px] md:text-[14px] font-medium md:font-light text-foreground/90">Secure Payments</span>
                </div>
                {/* Feature 4 */}
                <div className="flex flex-col md:flex-row items-center gap-3 justify-center text-center md:text-left min-w-[200px] md:min-w-0 snap-center bg-surface/50 md:bg-transparent p-4 md:p-0 rounded-2xl md:rounded-none">
                    ...
                    <span className="text-[13px] md:text-[14px] font-medium md:font-light text-foreground/90">Authentic Brands</span>
                </div>
            </div>
        </section>
    );
